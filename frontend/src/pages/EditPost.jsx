...
<input onChange={(e)=>setTitle(e.target.value)} value={title} type='text' placeholder='Enter Post Title' className='px-2 py-2 outline-none border-b border-gray-300 w-[40%]'/>
...
<textarea onChange={(e)=>setDesc(e.target.value)} value={desc} rows={15} cols={30} className='px-4 py-2 border border-black outline-none' placeholder='Enter Post Description'/>
